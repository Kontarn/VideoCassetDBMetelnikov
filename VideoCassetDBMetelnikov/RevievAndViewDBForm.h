...
namespace VideoCassetDBMetelnikov {
	...
	private: System::Windows::Forms::ToolStripMenuItem^  ËÁ·‡ÌÌÓÂToolStripMenuItem;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ËÁ·‡ÌÌÓÂToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->FindToDBButton->Text = L"œÓËÒÍ ÔÓ ·‡ÁÂ ";
			...
			this->ÏÂÌ˛ToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(3) {
				this->ÎË˜Ì˚È ‡·ËÌÂÚToolStripMenuItem,
					this->ËÁ·‡ÌÌÓÂToolStripMenuItem, this->‚˚ıÓ‰»Á¿ÍÍ‡ÛÌÚ‡ToolStripMenuItem
			});
			...
			this->ÎË˜Ì˚È ‡·ËÌÂÚToolStripMenuItem->Size = System::Drawing::Size(212, 26);
			this->ÎË˜Ì˚È ‡·ËÌÂÚToolStripMenuItem->Text = L"ÀË˜Ì˚È Í‡·ËÌÂÚ";
			// 
			// ËÁ·‡ÌÌÓÂToolStripMenuItem
			// 
			this->ËÁ·‡ÌÌÓÂToolStripMenuItem->Name = L"ËÁ·‡ÌÌÓÂToolStripMenuItem";
			this->ËÁ·‡ÌÌÓÂToolStripMenuItem->Size = System::Drawing::Size(212, 26);
			this->ËÁ·‡ÌÌÓÂToolStripMenuItem->Text = L"»Á·‡ÌÌÓÂ";
			// 
			// ‚˚ıÓ‰»Á¿ÍÍ‡ÛÌÚ‡ToolStripMenuItem
			// 
			this->‚˚ıÓ‰»Á¿ÍÍ‡ÛÌÚ‡ToolStripMenuItem->Name = L"‚˚ıÓ‰»Á¿ÍÍ‡ÛÌÚ‡ToolStripMenuItem";
			this->‚˚ıÓ‰»Á¿ÍÍ‡ÛÌÚ‡ToolStripMenuItem->Size = System::Drawing::Size(212, 26);
