...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ÎË˜Ì˚È ‡·ËÌÂÚToolStripMenuItem->Size = System::Drawing::Size(224, 26);
			this->ÎË˜Ì˚È ‡·ËÌÂÚToolStripMenuItem->Text = L"ÀË˜Ì˚È Í‡·ËÌÂÚ";
			this->ÎË˜Ì˚È ‡·ËÌÂÚToolStripMenuItem->Click += gcnew System::EventHandler(this, &RevievAndViewDBForm::ÎË˜Ì˚È ‡·ËÌÂÚToolStripMenuItem_Click);
			// 
			...
			this->‚˚ıÓ‰»Á¿ÍÍ‡ÛÌÚ‡ToolStripMenuItem->Click += gcnew System::EventHandler(this, &RevievAndViewDBForm::‚˚ıÓ‰»Á¿ÍÍ‡ÛÌÚ‡ToolStripMenuItem_Click);
			// 
			// RevievAndViewDBForm
			// 
...
private: System::Void ÎË˜Ì˚È ‡·ËÌÂÚToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e);
