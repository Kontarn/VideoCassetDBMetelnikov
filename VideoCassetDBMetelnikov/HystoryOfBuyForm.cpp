...
void VideoCassetDBMetelnikov::HystoryOfBuyForm::LoadData()
{
	...
	TransactDate AS ÄàòàÇàêàçà, ReturnDate AS ÄàòàÂîçâğàòà, Remark AS Êîììåíòàğèé FROM History								\
	...
	{
		MessageBox::Show("Îøèáêà âûâîäà Èñòîğèè çàêàçîâ", "Îøèáêà");
	}
}
...
void VideoCassetDBMetelnikov::HystoryOfBuyForm::mySubscriber(System::Object ^ sender, System::EventArgs ^ e, System::String ^ str)
{
	...
	{
		MessageBox::Show("Îøèáêà ìíîãîêğèòåğèàëüíîé ñîğòèğîâêè", "Îøèáêà");
	}
}
