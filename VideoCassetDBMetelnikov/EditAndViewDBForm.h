...
namespace VideoCassetDBMetelnikov {
	...
	private: System::Windows::Forms::ToolStripMenuItem^ изменитьКодДоступаToolStripMenuItem;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->историяЗаказовToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			this->изменитьКодДоступаToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			this->выходИзАккаунтаToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->menuStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(3) {
				this->историяЗаказовToolStripMenuItem,
					this->изменитьКодДоступаToolStripMenuItem, this->выходИзАккаунтаToolStripMenuItem
			});
			...
			// 
			this->историяЗаказовToolStripMenuItem->Name = L"историяЗаказовToolStripMenuItem";
			this->историяЗаказовToolStripMenuItem->Size = System::Drawing::Size(140, 24);
			this->историяЗаказовToolStripMenuItem->Text = L"История заказов";
			this->историяЗаказовToolStripMenuItem->Click += gcnew System::EventHandler(this, &EditAndViewDBForm::историяЗаказовToolStripMenuItem_Click_1);
			// 
			// изменитьКодДоступаToolStripMenuItem
			// 
			this->изменитьКодДоступаToolStripMenuItem->Name = L"изменитьКодДоступаToolStripMenuItem";
			this->изменитьКодДоступаToolStripMenuItem->Size = System::Drawing::Size(178, 24);
			this->изменитьКодДоступаToolStripMenuItem->Text = L"Изменить код доступа";
			this->изменитьКодДоступаToolStripMenuItem->Click += gcnew System::EventHandler(this, &EditAndViewDBForm::изменитьКодДоступаToolStripMenuItem_Click);
			// 
			// выходИзАккаунтаToolStripMenuItem
			// 
			this->выходИзАккаунтаToolStripMenuItem->Name = L"выходИзАккаунтаToolStripMenuItem";
			this->выходИзАккаунтаToolStripMenuItem->Size = System::Drawing::Size(151, 24);
			this->выходИзАккаунтаToolStripMenuItem->Text = L"Выход из аккаунта";
			this->выходИзАккаунтаToolStripMenuItem->Click += gcnew System::EventHandler(this, &EditAndViewDBForm::выходИзАккаунтаToolStripMenuItem_Click_1);
			// 
			// EditAndViewDBForm
			// 
			...
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &EditAndViewDBForm::EditAndViewDBForm_FormClosing);
...
private: System::Void историяЗаказовToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e);
...
private: System::Void сменитьКодДоступаToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e);
private: System::Void EditAndViewDBForm_FormClosing(System::Object^ sender, System::Windows::Forms::FormClosingEventArgs^ e);
private: System::Void выходИзАккаунтаToolStripMenuItem_Click_1(System::Object^ sender, System::EventArgs^ e);
private: System::Void изменитьКодДоступаToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e);
private: System::Void историяЗаказовToolStripMenuItem_Click_1(System::Object^ sender, System::EventArgs^ e);
};
}
