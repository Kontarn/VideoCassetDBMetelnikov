...
System::Void VideoCassetDBMetelnikov::EditAndViewDBForm::выходИзАккаунтаToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void VideoCassetDBMetelnikov::EditAndViewDBForm::сменитьКодДоступаToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
